...
namespace Alchemist
{
    ...
    public partial class syncroprogressfrm : Form
    {
        ...
        private int statusDataQueue = 0;        // 機械状態の総数
        ...
        private void refresh(Phase phase)
        {
            ...
            switch (phase)
            {
                ...
                case Phase.StatusReading:   /* 機械状態読み込み中 */
                    labelSet(lblStatusReading);
                    progressBarEach.Maximum = statusDataQueue;
                    progressBarEach.Value = statusDataQueue - ReservedCount;
                ...
                case Phase.WorkdataReading: /* 加工値読み込み中 */
                    ...
                    nowQueue = progressBarEach.Value + correctDataQueue + timingDataQueue + statusDataQueue;
                    break;
                ...
                case Phase.BankWriting:    /* バンクデータ書き込み中 */
                    ...
                    nowQueue = progressBarEach.Value + correctDataQueue + timingDataQueue + statusDataQueue + workDataQueue;
                    break;
            }
