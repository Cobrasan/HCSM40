...
namespace Alchemist
{
    ...
    public class SystemDataStorage
    {
...
#if DEBUG && HCSM40
        private string xmlFileName = Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + "\\JAM\\Alchemist\\HCSM40\\system.xml";
#else
        private string xmlFileName = Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + "\\JAM\\Alchemist\\system.xml";
#endif
        ...
        public void Save()
        {
            ...
            switch (tachpanel)
            {
                case SystemConstants.TENKEY_OFF:
                    str_tachpanel = "disable";
                    break;
                case SystemConstants.TENKEY_ON:
